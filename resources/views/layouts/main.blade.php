    ...
    <body>
      <header>
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="collapse navbar-collapse" id="navbar">
            <a href="/" class="navbar-brand"><img src="/img/hdcevents_logo.svg" width="50px" alt="HDC Events"></a>
            <ul class="navbar-nav">
      ...
      <main>
        <div class="container-fluid">
          <div class="row">
            @if (session("msg"))
            <p class="alert alert-success m-0 rounded-0 text-center">{{session("msg")}}</p>
            @endif
            @yield('content')
          </div>
        </div>
